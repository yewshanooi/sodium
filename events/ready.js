...
module.exports = client => {
	if (!process.env.BRAINSHOP_BID) console.log(`${chalk.yellowBright.bold('[Warning]')} The enviromental variable ${chalk.bold('BRAINSHOP_BID')} is not set`);
	if (!process.env.BRAINSHOP_API_KEY) console.log(`${chalk.yellowBright.bold('[Warning]')} The enviromental variable ${chalk.bold('BRAINSHOP_API_KEY')} is not set`);
