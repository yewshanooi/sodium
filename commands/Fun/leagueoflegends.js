...
module.exports = {
	data: new SlashCommandBuilder()
		...
		.addStringOption(option => option.setName('gamename').setDescription('Enter a Game Name').setRequired(true))
		.addStringOption(option => option.setName('tagline').setDescription('Enter a Tagline').setRequired(true))
