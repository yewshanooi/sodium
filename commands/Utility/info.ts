...
export default {
    ...
    execute: (client, interaction) => {
        const channelField: any = interaction.options.getChannel('channel');
        const roleField: any = interaction.options.getRole('role');
        const userField: any = interaction.options.getUser('user');
		const memberUserField: any = interaction.options.getMember('user');
        ...
        if (interaction.options.getSubcommand() === 'client') {
            ...
            const clientEmbed = new EmbedBuilder()
                ...
                .addFields(
                    ...
                    { name: 'Embed Color (HEX)', value: `\`#${client.embedColor}\``, inline: true },
        ...
        if (interaction.options.getSubcommand() === 'guild') {
            ...
            const guildEmbed = new EmbedBuilder()
                ...
                .addFields(
                    ...
                    { name: 'Channels', value: `\`${interaction.guild.channels.cache.filter((ch : any) => ch.type !== 'category').size}\``, inline: true },
