...
export default {
    ...
    execute: async (client, interaction) => {
        ...
        if (!interaction.member.permissions.has(PermissionsBitField.Flags.CreateInstantInvite)) return interaction.reply({ embeds: [client.errors.noPermission] });
        ...
        const { channel } = interaction;
            ...
            const invite = await interaction.guild!.invites.create(channel!.id, { maxAge: durationField, maxUses: limitField })
                .catch(() => {
